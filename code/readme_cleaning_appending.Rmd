...
# Changes to missing or underrepresented GreenWheel daily payments after original data comparison

```{r}
gw$daily_income_boda[gw$`Respondent ID` == "GW29"] <- 1000
gw$daily_income_boda[gw$`Respondent ID` == "GW95"] <- 1000
gw$daily_income_boda[gw$`Respondent ID` == "GW50"] <- 850
```
