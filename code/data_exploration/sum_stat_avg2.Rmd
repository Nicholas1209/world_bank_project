...
data_1 <- suppressMessages(read_excel('C:/Users/yengl/OneDrive/Documents/World Bank Project/appended_df.xlsx'))
...
data_1 <- data_1 %>% 
    mutate(gender = ifelse(gender == "Male", 1, 0),
           ...
           acc = ifelse(acc_med == "Yes, I have previously been in an accident that required medical care", 1, 0))

data_1 <- data_1 %>%
  filter(data_1$daily_income_boda < 3*sd(data_1$daily_income_boda, na.rm=TRUE))
```
